...
flowchart TB
    ...
    subgraph APP["<b>📱 应用层（Vue3 + uni-app）</b>"]
        direction TB
        GIS["🗺️ 态势一张图<br/>五图层叠加显示"]
        DASH["📊 双轨数据看板<br/>ECharts数据分析"]
        ALERT["🚨 预警工作台<br/>实时走私线索流 · SSE推送监控"]
        TASK["✅ 任务执行页<br/>检查清单 · 取证水印 · 派警调度"]
        DEV["🔧 传感器网络<br/>设备健康度 · 在线率监控"]
        INTEL["🧠 情报研判中心<br/>关系图谱 · 时段规律"]
        COMMAND["📡 联合指挥中心<br/>多部门协同 · 实时调度"]
        SPECIES["🦅 AR物种识别<br/>快速检测 · CITES比对"]
        PROFILE["👤 个人中心<br/>战果统计 · 执法记录"]
    end
