...
.sync-status-bar { position: relative; background: rgba(42,47,62,0.6); border-radius: 20rpx; padding: 20rpx 24rpx; border: 1px solid rgba(255,255,255,0.05); display: flex; align-items: center; gap: 16rpx; overflow: hidden; }
.sync-status-bar.synced { border-color: rgba(115,209,61,0.3); background: rgba(115,209,61,0.05); }
.sync-status-bar.syncing { border-color: rgba(255,169,64,0.3); background: rgba(255,169,64,0.05); }
.sync-status-bar.offline { border-color: rgba(255,77,79,0.3); background: rgba(255,77,79,0.05); }
...
.loading-spinner { width: 40rpx; height: 40rpx; border: 4px solid rgba(255,169,64,0.3); border-top-color: #FFA940; border-radius: 50%; animation: spin 1s linear infinite; }
...
.sync-progress-bar { position: absolute; bottom: 0; left: 0; right: 0; height: 4rpx; background: rgba(255,255,255,0.1); }
.progress-fill { height: 100%; background: linear-gradient(90deg, #FFA940 0%, #ffc069 100%); transition: width 0.3s ease; }
</style>
